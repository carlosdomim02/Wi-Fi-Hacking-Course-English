...
iptables -A FORWARD -i wlan0 -o wlan0 -s 10.5.2.128/25 -d 10.5.2.128/25 -j ACCEPT

# Allow and masquerade forwarding traffic from wireless to wired interface 
iptables -A FORWARD -s 10.5.2.128/25 -i wlan0 -o eth0 -j ACCEPT
iptables -A FORWARD -d 10.5.2.128/25 -i eth0 -o wlan0 -j ACCEPT
iptables -t nat -A POSTROUTING -s 10.5.2.128/25 -o eth0 -j SNAT --to 10.5.2.24
